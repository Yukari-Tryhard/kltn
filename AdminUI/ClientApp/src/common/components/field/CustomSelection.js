...
function CustomSelection(props) {
	...
	return (
		<div>
			<Select name={name} options={selectionArray} styles={colorStyles} onBlur={formik.handleBlur} onChange={(option) => formik.setFieldValue(name, option.value)} placeholder={placeholder ?? '---'} />
		</div>
	);
}
