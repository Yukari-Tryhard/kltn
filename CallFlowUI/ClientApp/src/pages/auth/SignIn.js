		...
		<div className="flex flex-row h-[100vh]">
			<div className="flex flex-[4_4_0%] flex-col gap-3 !items-center">
				...
				<div className="flex flex-col w-[60%] items-center mt-8">
					...
					<Link to={'/forgot-password'} className="mt-2 w-full underline underline-offset-2 font-bold text-sm cursor-pointer p-text-secondary">
						Forgot password
					</Link>
					<Button className="w-full !mt-12 p-ripple" label="Log in">
						<Ripple />
					</Button>
					<div className="mt-6 flex flex-row">
						Don't have account?{' '}
						<Link to={'/signup'} className="font-semibold ml-2 underline underline-offset-2 cursor-pointer p-component p-text-secondary">
							Sign up for free
						</Link>
					</div>
				</div>
